...
var AppsInit = common.Shortcut{
	...
	DryRun: func(ctx context.Context, rctx *common.RuntimeContext) *common.DryRunAPI {
		...
		if err != nil {
			...
			if e := ensureInitDirMatchesApp(dir, appID); e != nil {
				if existing, isSpark, rerr := readMetaAppID(dir); rerr == nil && isSpark && existing != "" {
...
func ensureInitDirMatchesApp(dir, appID string) error {
	existing, isSpark, err := readMetaAppID(dir)
	if err != nil {
...
func appsInitExecute(ctx context.Context, rctx *common.RuntimeContext) error {
	...
	if err := ensureInitDirMatchesApp(dir, appID); err != nil {
		return err
	}
