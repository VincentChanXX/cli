...
| [`+member-add`](references/lark-drive-member-add.md) | Add one or up to 10 collaborator/member permissions to a Drive document, file, folder, or wiki node; wraps Drive permission member create/batch_create and requires `--yes` for real writes |
